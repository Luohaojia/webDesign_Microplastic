    ...
    (e.Scene = function (n) {
        ...
        _ = function () {
          if (T && s && A.inFlow) {
            ...
            A.relSize.width || A.relSize.autoFullWidth ? (e ? i.css(T, { width: i.get.width(A.spacer) }) : i.css(T, { width: '100%' })) : ((o['min-width'] = i.get.width(t ? T : n, !0, !0)), (o.width = e ? o['min-width'] : 'auto')),
              A.relSize.height ? (e ? i.css(T, { height: i.get.height(A.spacer) - (A.pushFollowers ? d.duration : 0) }) : i.css(T, { height: '100%' })) : ((o['min-height'] = i.get.height(t ? n : T, !0, !r)), (o.height = e ? o['min-height'] : 'auto')),
      ...
      ;(this.setPin = function (e, n) {
        ...
        if (
          ...
          (A = { spacer: u, relSize: { width: '%' === c.width.slice(-1), height: '%' === c.height.slice(-1), autoFullWidth: 'auto' === c.width && a && i.isMarginCollapseType(l.display) }, pushFollowers: n.pushFollowers, inFlow: a }),
          !T.___origStyle)
        ) {
          T.___origStyle = {}
          var h = T.style,
